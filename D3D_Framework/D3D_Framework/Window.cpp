...
namespace D3D11Framework
{
	...
	bool Window::Create(const DescWindow& desc, HICON icon = nullptr)
	{
		_debug(Log::Get()->Debug("Window Create"));
		m_desc = desc;
		...
		wnd.cbWndExtra = 0;
		wnd.hInstance = 0;
		wnd.hIcon = icon == nullptr? LoadIcon(NULL, IDI_WINLOGO): icon;
	...
	void Window::Close()
	{
		...
		_debug(Log::Get()->Debug("Window Close"));
	}
